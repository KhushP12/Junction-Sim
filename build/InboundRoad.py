class InboundRoad:
    def __init__(self):
        ...
        # Note each direction will have a rating from 1-4
        # With 4 being the first priority and 1 being the least
        # Upon initialization i've set all the priorities to 0?
    ...
    def set_total_standard_lanes(self):
        return 1
    ...
    def set_has_bus_lane(self, has_bus):
    ...
    def set_has_left_lane(self, has_left):
